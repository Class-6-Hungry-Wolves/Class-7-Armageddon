...
def lambda_handler(event, context):
    ...
    # Setup the client
    endpoint = os.environ.get("SECRETS_MANAGER_ENDPOINT")  # can be None
    service_client = boto3.client('secretsmanager', endpoint_url=endpoint) if endpoint else boto3.client('secretsmanager')
