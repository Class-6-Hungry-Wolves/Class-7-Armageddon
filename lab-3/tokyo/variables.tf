...
variable "public_subnet_config" {
  ...
  default = {
    "shinjuku_public_subnet_1" = {
      cidr_block = "10.80.6.0/24"
      az         = "ap-northeast-1a"
    }
    "shinjuku_public_subnet_2" = {
      cidr_block = "10.80.8.0/24"
      az         = "ap-northeast-1c"
    }
    "shinjuku_public_subnet_3" = {
      cidr_block = "10.80.9.0/24"
      az         = "ap-northeast-1d"
    }
  }
}
...
variable "private_subnet_config" {
  ...
  default = {
    "shinjuku_private_subnet_1" = {
      cidr_block = "10.80.16.0/24"
      az         = "ap-northeast-1a"
    }
    "shinjuku_private_subnet_2" = {
      cidr_block = "10.80.18.0/24"
      az         = "ap-northeast-1c"
    }
    "shinjuku_private_subnet_3" = {
      cidr_block = "10.80.19.0/24"
      az         = "ap-northeast-1d"
    }
  }
}
...
variable "database_subnet_config" {
  ...
  default = {
    "shinjuku_database_subnet_1" = {
      cidr_block = "10.80.126.0/24"
      az         = "ap-northeast-1a"
    }
    "shinjuku_database_subnet_2" = {
      cidr_block = "10.80.128.0/24"
      az         = "ap-northeast-1c"
    }
    "shinjuku_database_subnet_3" = {
      cidr_block = "10.80.129.0/24"
      az         = "ap-northeast-1d"
    }
  }
}
