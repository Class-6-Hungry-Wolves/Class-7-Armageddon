resource "aws_cloudfront_distribution" "armageddon_cf01" {
  ...
  origin {
    ...
    # Explanation: CloudFront whispers the secret call of the Wraiths — the ALB only trusts this.
    custom_header {
      name  = "x-cf-wraith-call"
...
ordered_cache_behavior {
  ...
  web_acl_id = aws_wafv2_web_acl.armageddon_cf_waf01[0].arn
